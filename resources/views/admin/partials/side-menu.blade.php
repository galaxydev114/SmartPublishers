...
{{--    </div>--}}
    @php
        $allPermissionsArr = session()->get('permissions') ? session()->get('permissions')->toArray() : [];
    @endphp
    ...
    <div id="sidebar-menu">
        <ul>
            ...
            @if(!Auth::guard('admin')->user()->is_super && array_key_exists('subscription_page', $allPermissionsArr) && $allPermissionsArr['subscription_page'] == 1)
            <li>
                <a class="waves-effect" href="{{ route('subscription.index') }}"><i class="dripicons-rocket"></i>
                    <span> {{ __('globals.subscription.subscription') }} </span>
                </a>
            </li>
            @endif
            ...
            @endif
            @if(Auth::guard('admin')->user()->is_super == true || (sizeof($allPermissionsArr) > 0 && array_key_exists('campaign_management_page', $allPermissionsArr) && $allPermissionsArr['campaign_management_page'] == 1))
            <li>
            ...
            @else
                @if(sizeof($allPermissionsArr) > 0 && array_key_exists('ads_page', $allPermissionsArr) && $allPermissionsArr['ads_page'] == 1 && session()->get('cur_balance') >= 100)
                    <li>
                        <a href="{{ route('ads.index') }}" class="waves-effect"><i class="fa fa-buysellads"></i> <span> {{ __('globals.common.advertising') }} </span> </a>
                    </li>
                @endif
            ...
            @if(sizeof($allPermissionsArr) > 0 && array_key_exists('report_page', $allPermissionsArr) && $allPermissionsArr['report_page'] == 1)
            <li>
                <a href="{{ route('reports.index') }}" class="waves-effect"><i class="mdi mdi-message-outline"></i> <span> {{ __('globals.common.reports') }} </span> </a>
            </li>
            @endif

            @if(Auth::guard('admin')->user()->is_super == true || (sizeof($allPermissionsArr) > 0  && array_key_exists('campaign_page', $allPermissionsArr) && $allPermissionsArr['campaign_page'] == 1))
            <li>
                <a href="{{ route('sheet.index') }}" class="waves-effect"><i class="mdi mdi-file-document"></i> <span> {{ __('globals.common.sheet') }} </span> </a>
            </li>
            @endif

            @if(Auth::guard('admin')->user()->is_super == true || (sizeof($allPermissionsArr) > 0 && array_key_exists('site_ranking_page', $allPermissionsArr) && $allPermissionsArr['site_ranking_page'] == 1))
            <li>
                <a href="{{ route('site_ranking.index') }}" class="waves-effect"><i class="ion-android-sort"></i> <span> {{ __('globals.common.site_ranking') }} </span> </a>
            </li>
            @endif

            @if(Auth::guard('admin')->user()->is_super == true || (sizeof($allPermissionsArr) > 0 && array_key_exists('financial_setting', $allPermissionsArr) && $allPermissionsArr['financial_setting'] == 1))
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        ...
                        @endif
                        @if(sizeof($allPermissionsArr) > 0 && array_key_exists('payment_history', $allPermissionsArr) && $allPermissionsArr['payment_history'] == 1)
            ...
            @if(Auth::guard('admin')->user()->is_super == true && sizeof($allPermissionsArr) > 0 && array_key_exists('subscription_page', $allPermissionsArr) && $allPermissionsArr['subscription_page'] == 1)
                <li class="has_sub">
                    <a class="waves-effect"><i class="mdi mdi-star-circle"></i> <span> {{ __('globals.subscription.subscription') }} </span> </a>
                    <ul class="list-unstyled">
                        <li><a href="{{ route('subscription_list.index') }}"><i class="mdi mdi-view-list"></i>{!! __('globals.subscription.subscription_list') !!}</a></li>
                    </ul>
                </li>
            @endif

            @if(Auth::guard('admin')->user()->is_super == true || (sizeof($allPermissionsArr) > 0 && array_key_exists('content_page', $allPermissionsArr) && $allPermissionsArr['content_page'] == 1))
                <li>
