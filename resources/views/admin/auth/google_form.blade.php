...
<head>
    ...
    <title>Smart Publishers Plataforma :: Formulário</title>
...
<!-- Top content -->
    <div class="top-content">
        <div class="container">
            ...
            <p class="text-muted text-center font-18 m-t-15">© Copyright 2021 Smart Publishers Todos os Direitos Reservados</p>
        </div>
    </div>
