...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title>Smart Publishers Plataforma :: Recuperar Senha</title>
        ...
        <div class="wrapper-page">
            <div class="card">
                <div class="card-block">
                    ...
                    <h4 class="text-muted text-center font-18"><b>Recuperar Senha</b></h4>
                    <div class="p-3">
                        <form class="form-horizontal m-t-20" role="form" method="POST" action="{{ route('admin.send_reset_mail') }}" id="forgot_password_form">
                            ...
                            <div class="form-group text-center row m-t-20">
                                <div class="col-12">
                                    <button class="btn btn-primary btn-block waves-effect waves-light" type="submit">Enviar E-mail</button>
                                </div>
                            </div>
                        </form>
                    </div>
