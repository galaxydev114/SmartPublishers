                                        ...
                                        <div class="col-md-12 row" >
                                            ...
                                            <select class="custom-select col-md-1" id="sch_custom_from">
                                                @for($index = 0; $index < 24; $index++)
                                                    @if($index < 13)
                                                        @if($index == 12)
                                                            <option value="{{ $index }}">{{ $index }} Tarde</option>
                                                        @elseif($index == 0)
                                                            <option value="{{ $index }}">12 Manhã</option>
                                                        @else
                                                            <option value="{{ $index }}">{{ $index }} Manhã</option>
                                                        @endif
                                                    @else
                                                        <option value="{{ $index }}">{{ $index - 12 }} Tarde</option>
                                                    @endif
                                                @endfor
                                            </select>
                                            ...
                                            <select class="custom-select col-md-1" id="sch_custom_until">
                                                @for($index = 1; $index < 25; $index++)
                                                    @if($index < 13)
                                                        ...
                                                        @endif
                                                    @elseif($index == 24)
                                                        <option value="{{ $index }}" selected>{{ $index - 12 }} Manhã</option>
                                                    @else
                                                        <option value="{{ $index }}">{{ $index - 12 }} Tarde</option>
                                                    @endif
                                                @endfor
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                if($result['activity_schedule']['mode'] === 'CUSTOM')
                                                                {
                                                                    ...
                                                                    {
                                                                        if(strpos($rule['day'], strtoupper($key)) > -1)
                                                                        {
                                                                            $existFlag = 2;
                                                                            $selectVal = $rule['type'];
                                                                            $from = $rule['from_hour'];
                                                            ...
                                                            {{ $selectVal === 'ALL' || $selectVal === 'EXCLUDE' || $existFlag === 0 ? 'disabled' : ''}}>
                                                                @for($index = 0; $index < 24; $index++)
                                                                    @if($index < 13)
                                                                        @if($index == 12)
                                                                            @if($index === $from)
                                                                                <option value="{{ $index }}" selected>{{ $index }} Tarde</option>
                                                                            @else
                                                                                <option value="{{ $index }}">{{ $index }} Tarde</option>
                                                                            @endif
                                                                        @elseif($index == 0)
                                                                            @if($index === $from)
                                                                                <option value="{{ $index }}" selected>12 Manhã</option>
                                                                            @else
                                                                                <option value="{{ $index }}">12 Manhã</option>
                                                                            @endif
                                                                        @else
                                                                            @if($index === $from)
                                                                                <option value="{{ $index }}" selected>{{ $index }} Manhã</option>
                                                                            @else
                                                                                <option value="{{ $index }}">{{ $index }} Manhã</option>
                                                                            @endif
                                                                        @endif
                                                                    @else
                                                                        @if($index === $from)
                                                                            <option value="{{ $index }}" selected>{{ $index - 12 }} Tarde</option>
                                                                        @else
                                                                            <option value="{{ $index }}">{{ $index - 12 }} Tarde</option>
                                                                        @endif
                                                                    @endif
                                                                ...
                                                                @for($index = 1; $index < 25; $index++)
                                                                    ...
                                                                    @elseif($index == 24)
                                                                        @if($index === $until)
                                                                            <option value="{{ $index }}" selected>{{ $index - 12 }} Manhã</option>
                                                                        @else
                                                                            <option value="{{ $index }}">{{ $index - 12 }} Manhã</option>
                                                                        @endif
                                                                    @else
                                                                        @if($index === $until)
                                                                            <option value="{{ $index }}" selected>{{ $index - 12 }} Tarde</option>
