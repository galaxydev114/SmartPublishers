                    ...
                    <div class="card-block">
                        ...
                        <form method="post" action="{{ route('admins.update', $admin->id) }}" enctype="multipart/form-data">
                            ...
                            @if($errors->has('view_id'))
                                has-danger
                            @endif">
                                <label class="col-sm-2 col-form-label">Ver IDS <span class="text-danger">*</span></label>
                                <div class="col-sm-5">
                            ...
                            @if($errors->has('account_name'))
                                has-danger
                            @endif">
                                <label class="col-sm-2 col-form-label">Nome da Conta <span class="text-danger">*</span></label>
                                <div class="col-sm-5">
