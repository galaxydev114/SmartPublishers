                        ...
                        <form method="post" action="{{ route('admins.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <label class="custom-control custom-checkbox">
                                        {{ Form::checkbox('site_raning_page', null, old('site_raning_page'), array('id'=>'site_raning_page', 'class'=> 'custom-control-input')) }}
                                        <span class="custom-control-indicator"></span>
                                    ...
                                    <label class="custom-control custom-checkbox">
                                        {{ Form::checkbox('show_total_row', null, old('show_total_row'), array('id'=>'show_total_row', 'class'=> 'custom-control-input')) }}
                                        <span class="custom-control-indicator"></span>
                                        <span class="custom-control-description">{{ __('globals.common.show_total_row') }}</span>
                                    </label>

                                    <label class="custom-control custom-checkbox">
                                        {{ Form::checkbox('subscription_page', null, old('subscription_page'), array('id'=>'subscription_page', 'class'=> 'custom-control-input')) }}
                                        <span class="custom-control-indicator"></span>
