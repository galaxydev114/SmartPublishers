            ...
            @if($fetch_error != '')
                <div class="justify-content-between col-md-12">
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <strong>{{ __('globals.msg.alert') }}</strong> {{ $fetch_error }}
                    </div>
                </div>
            @endif
                <div class="col-md-6">
                    <div class="card m-b-20">
                        <div class="card-block">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#tab-users" role="tab">Usuarios</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab-sessions" role="tab">Sessões</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab-bouncerate" role="tab">Taxa de Saída</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#tab-sessionduration" role="tab">Tempo</a>
                                </li>
                            </ul>
                ...
                <div class="col-md-3">
                    <div class="card m-b-20" style="background-color: #67a8e4; color: #fff; height: 431.5px;">
                        <div class="card-block">
                            <h4 class="mt-0 header-title">Usuários ativos agora</h4>
                            <h1>{{ $activeusers }}</h1>
                            <div class="row">
                                <div class="col-md-9">
                                    <p style="font-size: 12px;">Top páginas ativas</p>
                                    @if( $activepages !=null )
                                ...
                                <div class="col-md-3">
                                    <p style="font-size: 12px; text-align: right;">Usuários ativos</p>
                                    @if( $activepages !=null )
                                        @foreach($activepages as $page)
                ...
                <div class="col-md-3">
                    <div class="card m-b-20" style="">
                        <div class="card-block">
                            <h4 class="mt-0 header-title">Mais usuários retornaram ao site em
                            ...
                            <p style="font-size: 14px;">Você tinha {{ $users_latestMonth }} users, {{ $users_latestMonth - $newUser_latestMonth }} came back in {{ $letter_latestMonth }}, which means {{ $return_users_latestMonth }}% de seus usuários retornaram ao seu site.</p>
                            @endif
                ...
                <div class="col-md-9">
                    <div class="card m-b-20">
                        <div class="card-block">
                            <p class="text-muted m-b-30 font-14">Sessão por País</p>
                            <div class="row">
                                <div class="col-md-7">
                ...
                <div class="col-md-3">
                    <div class="card m-b-20">
                        <div class="card-block">
                            <p class="text-muted m-b-30 font-14">Quais são seus principais dispositivos ?</p>
                ...
                <div class="col-md-12 btm-tbl">
                    <div class="card m-b-20">
                        <div class="card-block">
                            <h4 class="mt-0 header-title">Analisar Receita - Campanha X Conteúdo</h4>
                            <table id="datatable_data" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Engajamento</th>
                                        <th>Tempo</th>
                                        <th id="adsenserev">Receita({{ $curcurrency }})</th>
                                        <th>Anuncios Clicados</th>
                                        <th>Impressões</th>
                                        <th>CTR</th>
                                        <th id="adsensecpm">eCPM({{ $curcurrency }})</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
                    ...
                    <table id="datatable_site_data" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Engajamento</th>
                                <th>Tempo</th>
                                <th id="site_adsenserev">Receita({{ $curcurrency }})</th>
                                <th>Anuncios Clicados</th>
                                <th>Impressões</th>
                                <th>CTR</th>
                                <th id="site_adsensecpm">eCPM({{ $curcurrency }})</th>
                            </tr>
                        </thead>
