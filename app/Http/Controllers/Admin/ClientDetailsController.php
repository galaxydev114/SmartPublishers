...
class ClientDetailsController extends Controller
{
    ...
    public function saveData(Request $request)
    {
        ...
        if(!$curUser)
        {
            ...
            $admin->trial_type = 1;
            $admin->trial_start = Carbon::now()->format('Y-m-d');
            $admin->trial_end = Carbon::now()->addMonth()->format('Y-m-d');
            $admin->trial_ends_at = Carbon::now()->addMonth()->format('Y-m-d H:i:s');
            ...
            //Trial User Default Permission Add
            ClientSetting::query()->updateOrInsert(['user_id' => $user_id, 'page_key' => 'report_page'], ['user_id' => $user_id, 'page_key' => 'report_page', 'show_rule' => 1, 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")]);
            ClientSetting::query()->updateOrInsert(['user_id' => $user_id, 'page_key' => 'campaign_management_page'], ['user_id' => $user_id, 'page_key' => 'campaign_management_page', 'show_rule' => 1, 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")]);
            ClientSetting::query()->updateOrInsert(['user_id' => $user_id, 'page_key' => 'ads_page'], ['user_id' => $user_id, 'page_key' => 'ads_page', 'show_rule' => 1, 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")]);
            ClientSetting::query()->updateOrInsert(['user_id' => $user_id, 'page_key' => 'campaign_page'], ['user_id' => $user_id, 'page_key' => 'campaign_page', 'show_rule' => 1, 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")]);
            ClientSetting::query()->updateOrInsert(['user_id' => $user_id, 'page_key' => 'column_visibility'], ['user_id' => $user_id, 'page_key' => 'column_visibility', 'show_rule' => 1, 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")]);
            ...
            ClientSetting::query()->updateOrInsert(['user_id' => $user_id, 'page_key' => 'utm_generator'], ['user_id' => $user_id, 'page_key' => 'utm_generator', 'show_rule' => 1, 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")]);
            ClientSetting::query()->updateOrInsert(['user_id' => $user_id, 'page_key' => 'site_ranking_page'], ['user_id' => $user_id, 'page_key' => 'site_ranking_page', 'show_rule' => 0, 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")]);
            ClientSetting::query()->updateOrInsert(['user_id' => $user_id, 'page_key' => 'site_ranking_page'], ['user_id' => $user_id, 'page_key' => 'show_total_row', 'show_rule' => 0, 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")]);
