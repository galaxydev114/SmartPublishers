...
class CampaignController extends Controller
{
    ...
    public function index()
    {
        ...
        Report::allCmpPause();
        /////////////////////////////////////////////////////////////////////////////
        return view('admin.campaign.index', ['title'=>__('globals.campaigns.campaign_management'), 'allCampaigns' => session()->get('all_cmp_ads_list')]);
    }
    ...
    {
        if((sizeof(session('permissions')) > 0 && session('permissions')['campaign_management_page'] == 0) || (session()->get('cur_balance') < 100 && Report::isTrialExpried()))
        {
