...
class GoogleAnalytics{
    ...
    static function getSiteList($view_id, $dimensions, $metrics, $start_date, $end_date, $cmp_id = '', $attach_condition = '')
    {
        // to make the request quicker
        ...
        try{
            ...
            } else if($attach_condition != '')
            {
                $options['filters'] = $attach_condition;
            }
